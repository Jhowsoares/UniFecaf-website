        ...
        semestres: [
          ...
          },
          {
            ...
            disciplinas: [
              ...
              "Cálculo - Limites e Derivadas.",
              "Modelagem de Sistemas Elétricos e Eletromagnéticos.",
              "Modelagem de Sistemas Físico-Químicos.",
            ],
          },
        ],
      },
        ...
        semestres: [
          {
            ...
            disciplinas: [
              ...
              "Modelagem de Sistemas Ópticos e Ondulatórios.",
              "Cálculo: Integrais.",
              "Estatística e Mecânica dos Sólidos.",
            ],
          },
          {
            semestre: "4º Semestre",
            disciplinas: [
              "Hidraulica: Condutos Forçados e Instalações Elevatórias.",
              "Eletrotécnica.",
              "Mecânica dos solos, das Rochas e Elementos de Geologia.",
              "Comportamento Químico e Mecânico dos Materiais.",
              "Materiais de Construção e Técnicas Construtivas.",
        ...
        semestres: [
          {
            semestre: "5º Semestre",
            disciplinas: [
              "Projeto Arquitetônico e Lesgislações das Construções",
              "Fundações",
              "Hidráulica: Escoamentos Livres, Estruturas Hidráulicas, Hidráulica Fluivial e Transporte de Sedimentos.",
              "Estruturas de Concreto: Lajes e Vigas.",
              "Topografia e Sistemas de Georreferenciamento",
            ],
          },
          {
            semestre: "6º Semestre",
            disciplinas: [
              ...
              "O Direito da Construção Civil: Responsábilidade Civil e Penal",
        ...
        semestres: [
          {
            ...
            disciplinas: [
              "Eletiva - LIBRAS: Língua Brasileira de Sinais.",
              "Eletiva: Elaboração de Contratos na Construção Civil.",
              "Eletiva: Saneamento Básico.",
              "BIM - Building Information Modeling.",
              "Projetos de Instalações Hidraulicas Prediais.",
          ...
          },
          {
            ...
            disciplinas: [
              ...
              "Eletiva: DIY! Primeiros passos para Empreender",
              "Eletiva: Economia: Mico e Macro.",
              "Eletiva: Engenharia e Tecnologias Emergentes.",
              "Tópicos Especiais em Engenharia I.",
              "Estágio Supervisonado em Engenharia Civil I",
              "Ferramentas de Gestão para Construção Civil.",
              "Estruturas de Concreto e Projetos com Ferramentas Computacionais",
            ],
          },
        ],
      },
        ...
        semestres: [
          {
            ...
            disciplinas: [
              "Eletiva: Projeto Arqutetônico - Arquitetura Brasileira.",
              "Eletiva: Ética e Prática Profissional em Engenharia.",
              "Tópicos Especiais em Engenharia II.",
              "Eletiva: Sistemas de Transporte.",
              "Trabalho final de Graduação em Engenharia Civil.",
              "Análise e Comportamento das Estruturas.",
              "patologias das Construções.",
              "Atividades Complementares - 100 Horas.",
              "Extensão Curricularizada em Engenharia Civil.",
            ],
          },
          {
        ...
        semestres: [
          ...
          },
          {
            ...
            disciplinas: [
              ...
              "Comportamento Químico e Mecânico dos Materias.",
              "Circuitos Lógico-Digitais.",
              "Resistência dos Materias.",
              "Analise de Sinais de Sistemas Dinâmicos.",
            ],
          },
        ],
      },
        ...
        semestres: [
          {
            semestre: "5º Semestre",
            disciplinas: [
              "Desenho de Instalações Elétricas - CAD.",
              "Projetos de Circuitos-Elétrônicos: Diodos e Transistores.",
              "Eletromagnetismo Aplicado.",
              "Projeto de Placas PCB Eletrônicas - CAD.",
              "Instalações Elétricas Resisdenciais.",
            ],
          },
          {
            semestre: "6º Semestre",
            disciplinas: [
              "ELetiva: DIY! Primeiros passos para Empreender.",
              "Eletiva: LIBRAS: Língua Brasileira de Sinais.",
              "Hardware Programável e Reconfiguravél.",
              "Eletiva: Métodos Ágeis",
              "Microcontroladores e Sistemas Embarcados.",
              "Intalações Elétricas Industriais.",
        ...
        semestres: [
          {
            ...
            disciplinas: [
              ...
              "Eletiva: Controladores Programáveis.",
              "Geração, Tranmissão e Distribuição de Energia.",
              "Projetos de Circuitos Elétricos: Amplificadores Operecionais.",
              "Acionamento e Máquinas Elétricas",
            ],
          },
          {
            semestre: "8º Semestre",
            disciplinas: [
              ...
              "Tópicos Especiais em Engenharia I.",
              "Eletiva: Internet of Things.",
              "Eletiva: Intrumentação Industrial.",
        ...
        semestres: [
          {
            ...
            disciplinas: [
              ...
              "Trabalho de Conclusão de Curso em Engenharia da Elétrica.",
              "Tópicos Especiais em Engenharia II.",
              "Projeto de sistemas Fotovoltaicos e Parques Éolicos.",
          ...
          },
          {
            ...
            disciplinas: [
              "ESG: Sustentabilidade das Organizações.",
              "Gestão de Diversidades e Políticas de Inclusão.",
              "Extensão Curicularizada em Engenharia Elétrica",
              "Gestão de Projetos.",
              "Prototipação em Engenharia.",
              "Relacionamento Interpessoal.",
              "Saúde: Segurança e Qualidade de Vida no Trabalho.",
        ...
        semestres: [
          {
            ...
            disciplinas: [
              ...
              "Resolução eficaz de Problemas.",
              "Fenômenos de Transporte",
              "Modelagem de Sistemas Óticos e Ondulatórios.",
              "Calculo: Integrais",
              "Estatística e Mecânica dos Sólidos",
            ],
          },
        ...
        semestres: [
          {
            ...
            disciplinas: [
              ...
              "Ferramentas Lean manufacturing e Gestão de Qualidade, Produtividade e Inovação.",
              "Supply Chain.",
              "Jogos de Empresas.",
          ...
          },
          {
            semestre: "6º Semestre",
            disciplinas: [
              "Eletiva: Engenharia de Sistemas.",
              "Eletiva: Língua Brasileira de Sinais.",
              "Gerencia de Operações.",
              "Eletiva: Metodos Ágeis.",
              "Automação de Sistemas.",
              "Engeharia de Métodos e Layout.",
        ...
        semestres: [
          ...
          },
          {
            ...
            disciplinas: [
              ...
              "Eletiva: Engenharia e Tecnologias Emergentes.",
              "Tópicos Especiais em Engenharia I.",
              "Análise de Demostrações Financieiras Contábeis.",
              "Estágio Supervisionado em Engenharia de Produção.",
              "Industria 4.0 e Digitalização de Processos.",
            ],
          },
        ],
      },
        ...
        semestres: [
          {
            ...
            disciplinas: [
              ...
              "Tópicos Especiais em Engenharia II.",
              "Trabalho de Conclusão de Curso de Curso de Engenharia de Produção.",
              "Gestão Empresarial e Organizacional.",
              "CAD/CAM e Manufatura Digital.",
            ],
          },
          {
            semestre: "10º Semestre",
